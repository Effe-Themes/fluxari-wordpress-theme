...
<p><?php echo __('No results.', 'fluxari');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Latest Posts', 'fluxari');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Categories', 'fluxari');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php echo __('Tags', 'fluxari');?></h4>
<!-- /wp:heading -->
